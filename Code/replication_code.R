rm(list=ls()) 
setwd("/Users/chuchuwan/Desktop/georgetown/2025Spring/PPOL-6801-Data as Text/rep2")#working directory
options(scipen=999)
...
##Extension-Examining in non-gender related crimes, what kinds of words are used between different gender complaints
#E1
plot(stm.out.c, type = "perspectives", topics =24, main="Word Used for abdution realted crime, by gender of the complaints")
plot(stm.out.c, type = "perspectives", topics =6, main="Word Used for theft realted crime, by gender of the complaints")
plot(stm.out.c, type = "perspectives", topics =30, main="Word Used for alcohol realted crime, by gender of the complaints")

############Extension--Same logic but in Gender-related Crime#######
...
##Extension-Examining in non-gender related crimes, what kinds of words are used between gender
...
#E3
compare_content_words(stm.out.c, topic = 9, top_n = 12)
#E4
compare_content_words(stm.out.c, topic = 18, top_n = 12)
